      ...
      <div className="mx-auto max-w-4xl px-4 py-10 sm:px-6 sm:py-14 lg:px-8">
        ...
        <div className="mt-8">
          <ComplaintDocument
            ...
            footerNote="Your description and location are pulled from your real report. Subject, impact, and requested-action wording use a category template — not generated by a live AI/translation model."
